...
const FAQ = () => {
  return (
    <div className="faq-light dark:faq-dark">
      <div className="">
        <div className="flex justify-center items-center h-auto w-screen max-w-[90%] xl:max-w-[1200px] mx-auto pt-[200px] sm:pt-[160px] md:pt-[120px] lg:py-16">
          <div className="">
            <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
              ...
              <div className="max-w-[1200px] mx-auto">
                <div className="hs-accordion-group dark:abs-home shadow-2xl rounded-xl">
>>>>>>> new-production
                  <div
                    className="hs-accordion hs-accordion-active:bg-gray-100 rounded-xl p-6 dark:hs-accordion-active:bg-white/[.05] active"
                    id="hs-basic-with-title-and-arrow-stretched-heading-one"
                  ...
                  >
                    ...
                    >
                      <p className="text-gray-800 dark:text-gray-200">
                        ...
                        their availability and pricing. People looking for a
                        ride or car rental can search for available options on
                        the website using various filters, such as location,
                        date, type of car, and price range. Once they find a
                        suitable option, they can book the ride or car through
                        the website and pay online. After the ride or car
                        rental, users can leave a review of their experience to
                  ...
                  >
                    ...
                    >
                      <p className="text-gray-800 dark:text-gray-200">
                        ...
                        Name] through our messaging system. Once you have booked
                        a ride or car rental, you will be able to exchange
                        messages with the car owner or driver through the
                        website. This messaging system is designed to provide a
                        secure and convenient way for you to communicate with
                        the car owner or driver, without the need to exchange
