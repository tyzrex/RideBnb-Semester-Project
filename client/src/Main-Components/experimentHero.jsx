...
import CarImg from "../assets/hero.svg";
...
const ExperimentHero = () => {
  ...
  return (
    <div
<<<<<<< HEAD
      className={` h-auto text-black bg-gray-200 flex`}
...
<<<<<<< HEAD
            <h1 className="md:text-5xl sm:text-5xl text-4xl z-10 font-semibold md:py-6 md:max-w-xl text-black lg:text-left text-center">
              Discover your perfect ride, hit the road with{" "}
              <span className="text-indigo-500">Confidence</span>
            </h1>
            <div className="">
              <button className="bg-fuchsia-500 animate-[bounceIn_1s_ease-in-out] hover:bg-white transition-all ease-in-out duration-500 w-[200px] rounded-full font-bold my-6 mx-auto py-3 text-white hover:text-black ">
=======
