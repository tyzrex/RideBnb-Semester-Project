...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-full mx-auto lg:max-w-[1300px] max-w-[95%] z-[0] py-[400px] md:py-[200px] h-full mt-[-250px] md:mt-[-80px] lg:mt-[0px] lg:flex lg:justify-around lg:items-center md:grid grid gap-0 content-center justify-items-center md:justify-items-center md:content-center sm:content-center sm:justify-items-center">
      ...
      <div className="absolute z-[2] translate-y-[50%] self-end">
